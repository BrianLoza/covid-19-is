...
<head>
  ...
  <title>Sistema de Pronosticacion</title>
</head>
<body>


    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="index.php">Sistema de Pronosticacion del covid-19</a>
      <!--
    ...
    <footer class="page-footer font-small" style="background-color: #343A40; color: #FFF; margin-top: 150px">
      ...
      <!-- Copyright -->
      <div class="footer-copyright text-center py-3">© 2020 Todos los derechos reservados MAM
        <br>
        <a href="http://www.virtual.sistemasuncp.edu.pe/" target="_blank"> Facultad de Ingeniería de Sistemas | UAB</a>
      </div>
      <!-- Copyright -->
